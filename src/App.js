...
import IsticharaList from './pages/IsticharaList';
  ...
  return (
    <Router>
      <Routes>
        ...
        <Route path="/istichara" element={state.user && state.user.role === "client" ? <Istichara /> : <Navigate to="/login" />} />

        <Route path="/" element={<Home />} />
        <Route path="/attorneys" element={<Attorneys />} /> 
        <Route path="/istichara-list" element={state.user ? <IsticharaList /> : <Navigate to="/login" />} />
